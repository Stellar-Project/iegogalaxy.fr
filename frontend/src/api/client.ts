...
export const api = {
  ...
  updateTimelineEvent: (id: string, data: Partial<TimelineEvent>) =>
    request<TimelineEvent>(`/timeline/${id}`, { method: "PUT", body: JSON.stringify(data) }),
  ...
  createCredit: (data: Partial<Credit>) =>
    request<Credit>("/credits", { method: "POST", body: JSON.stringify(data) }),
  updateCredit: (id: string, data: Partial<Credit>) =>
    request<Credit>(`/credits/${id}`, { method: "PUT", body: JSON.stringify(data) }),
  ...
  createScreenshot: (data: Partial<Screenshot>) =>
    request<Screenshot>("/screenshots", { method: "POST", body: JSON.stringify(data) }),
  updateScreenshot: (id: string, data: Partial<Screenshot>) =>
    request<Screenshot>(`/screenshots/${id}`, { method: "PUT", body: JSON.stringify(data) }),
  ...
  createPost: (data: PostInput) => request<Post>("/blog", { method: "POST", body: JSON.stringify(data) }),
  updatePost: (id: string, data: Partial<PostInput>) => request<Post>(`/blog/${id}`, { method: "PUT", body: JSON.stringify(data) }),
  ...
  createHero: (data: Partial<HeroBackground>) =>
    request<HeroBackground>("/hero", { method: "POST", body: JSON.stringify(data) }),
  updateHero: (id: string, data: Partial<HeroBackground>) =>
    request<HeroBackground>(`/hero/${id}`, { method: "PUT", body: JSON.stringify(data) }),
  ...
  updateWikiTool: (id: string, data: Partial<WikiTool>) =>
    request<WikiTool>(`/wiki/tools/${id}`, { method: "PUT", body: JSON.stringify(data) }),
  ...
  createWikiPage: (data: Partial<WikiPage>) =>
    request<WikiPage>("/wiki/pages", { method: "POST", body: JSON.stringify(data) }),
  updateWikiPage: (id: string, data: Partial<WikiPage>) =>
    request<WikiPage>(`/wiki/pages/${id}`, { method: "PUT", body: JSON.stringify(data) }),
