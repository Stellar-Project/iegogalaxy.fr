...
export default function BlogPost() {
  ...
  if (!post) return (
    <div className="min-h-screen bg-background flex flex-col items-center justify-center text-slate-400 gap-4">
