        ...
        <Card className="bg-slate-900 border-white/10">
          <CardContent className="p-4 space-y-3">
            <div className="grid grid-cols-2 gap-3">
              ...
              />
              <Input
                placeholder="Slug (ex: nouvelle-version)"
                value={form.slug}
            ...
            <div className="grid grid-cols-2 gap-3">
              <Input
                placeholder="Catégorie (ex: technique, annonce)"
                value={form.category || ""}
            ...
            <Label className="flex items-center gap-2 text-sm text-slate-300">
              <Switch checked={form.published} onCheckedChange={(v) => setForm({ ...form, published: v })} /> Publié
            </Label>
            ...
            <CardContent className="p-4 flex items-center justify-between">
              <div className="flex-1 min-w-0">
                ...
                <p className="text-xs text-slate-500 mt-0.5">
                  /{p.slug} — {new Date(p.createdAt).toLocaleDateString("fr-FR")}
                </p>
              </div>
