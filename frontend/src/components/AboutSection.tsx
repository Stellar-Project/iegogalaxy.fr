import { Gamepad2, ChevronRight, History, Layers, Sparkles } from "lucide-react";
    ...
    <section className="relative z-10 py-20 px-4 sm:px-6">
      <div className="max-w-6xl mx-auto space-y-12">
        ...
        <div className="grid md:grid-cols-2 gap-6 sm:gap-8 items-stretch">
          <Card className="h-full bg-card border-border hover:border-accent/50 transition-colors flex flex-col justify-between">
                  ...
                  >
                    <div
                      className={`h-2 w-2 mt-1.5 rounded-full shrink-0 ${
                        c.highlight ? "bg-primary" : "bg-muted-foreground/60"
                      }`}
                    />
