  ...
  const socialLinks: SocialLink[] = [
    {
      ...
      colorClass: "hover:text-blue-400 hover:bg-blue-400/10",
      label: "Twitter",
    },
    {
      icon: Github,
    ...
    },
    {
      ...
      colorClass: "hover:text-red-500 hover:bg-red-500/10",
      label: "YouTube",
    },
  ];
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12">
            <div className="space-y-4">
              ...
              <p className="leading-relaxed text-slate-500">
                ...
                Galaxy. Redécouvrez l'aventure spatiale sans barrière de langue.
              </p>
            </div>
              ...
              <ul className="space-y-2">
                {[
                  ...
                  <li key={link.href}>
                    <Button
                      variant="link"
                      className="p-0 h-auto text-slate-400 hover:text-yellow-400 transition-colors"
                      asChild
                    >
            ...
            <div>
              ...
              <ul className="space-y-2 text-slate-500">
                <li>
                  Inazuma Eleven est une marque déposée de{" "}
                  <strong className="text-slate-400">Level-5 Inc.</strong>
                </li>
            ...
            <div className="flex flex-col items-start md:items-end space-y-4">
              ...
              <div className="flex gap-3">
                {socialLinks.map((social, index) => (
                  <Button
                    ...
                    variant="outline"
                    size="icon"
                    className={`bg-slate-900 border-white/5 transition-all duration-300 hover:scale-110 hover:border-white/10 ${social.colorClass}`}
                    asChild
                  >
                    <a
                      href={social.href}
              ...
              <p>Version du site : {websiteVersion}</p>
            </div>
          </div>
